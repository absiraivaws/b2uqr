...
export default function SetPinPage() {
	...
	const params = useParams() as { companySlug?: string; branchSlug?: string };
	...
	const handleSubmit = async (e?: React.FormEvent) => {
		...
		setLoading(true);
		try {
			const res = await fetch('/api/branch-manager/set-pin', {
				method: 'POST',
	...
	return (
		<main className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto md:min-h-screen md:flex md:flex-col md:justify-center">
			<Card>
				<CardHeader>
					<CardTitle>Set branch PIN</CardTitle>
					<CardDescription>Set a 4-digit PIN for your branch manager account.</CardDescription>
				</CardHeader>
