...
export default function AdminResetPasswordRequestPage() {
	...
	// Redirect after a short countdown when sent
	React.useEffect(() => {
		if (!sent) return;
		...
		<main className="p-4 sm:p-6 lg:p-8 max-w-2xl mx-auto md:min-h-screen md:flex md:flex-col md:justify-center">
			<Card>
				<CardHeader>
					...
					<CardDescription>Enter the admin email to request a password reset link.</CardDescription>
				</CardHeader>
						...
						<form onSubmit={handleSubmit} className="space-y-4">
							<div className="space-y-2">
								<div className="flex items-center justify-between">
									<h3 className="text-sm font-medium">Admin email</h3>
								</div>
